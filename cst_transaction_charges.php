...
if($_GET['action'] == 'save'){
	...
	foreach ($_POST[charges] as &$charge_line){
		...
		if(trim($charge[0]) == trim($_POST['Connection_Feesproduct'])){
			...
			$charge[5] = $_POST['Connection_Feesproduct_quantity'];
			$charge[6] = $_POST['Connection_Feesproduct_discount'];
		}else{
		...
		if(trim($charge[0]) == trim($_POST['Equipment_Saleproduct'])){
			...
			$charge[5] = $_POST['Equipment_Saleproduct_quantity'];
			$charge[6] = $_POST['Equipment_Saleproduct_discount'];
		}else{
		...
		if(trim($charge[0]) == trim($_POST['Equipment_Depositsproduct'])){
			...
			$charge[5] = $_POST['Equipment_Depositsproduct_quantity'];
			$charge[6] = $_POST['Equipment_Depositsproduct_discount'];
		}else{
		...
		if(trim($charge[0]) == trim($_POST['Access_Point_Feesproduct'])){
			...
			$charge[5] = $_POST['Access_Point_Feesproduct_quantity'];
			$charge[6] = $_POST['Access_Point_Feesproduct_discount'];
		}else{
