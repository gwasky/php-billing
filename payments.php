...
$MM_authorizedUsers = "Treasury,Finance Credit and Control,Finance - Collections,Customer Care - Operations,Customer Care CS SMT,Customer Care - CC Operations,Super,Bill Delivery,CC Sales";
...
<?php require_once('../Connections/sugar.php'); 
	...
	if($_POST[download_statement]){
		$title = "Account Statement for Account number ".$_REQUEST[parent_id];
		generate_excel_file($statement,$title);
	}
...
<table width="100%" border="0" cellspacing="1">
  ...
  <tr>
    ...
    <span class="style14">Start Date: </span>
    <input name="start_date" id="start_date" value="<? echo $_POST[start_date]; ?>" wdg:mondayfirst="false" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:type="widget" wdg:singleclick="false" wdg:restricttomask="no" wdg:readonly="true" />
    <span class="style14">End Date:</span>
    <input name="end_date" id="end_date" value="<? echo $_POST[end_date]; ?>" wdg:mondayfirst="false" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:type="widget" wdg:singleclick="false" wdg:restricttomask="no" wdg:readonly="true" />
    <input name="button2" type="submit" class="style14" id="button2" value="View Statement" />
    <input name="download_statement" type="submit" class="style14" id="download_statement" value="Download Statement" />
    </form></td>
  </tr>
  <tr>
    <td colspan="2">
