...
function save_payement(){
	...
	$to = 'CREDITCOLLECTION@waridtel.co.ug,Leonard Kibuuka/Finance/Kampala <leonard.kibuuka@ug.airtel.com>, Jude Nkorabyona/Enterpise/Airtel Ug <Jude.nkorabyona@ug.airtel.com>, Rita Tamale/Enterpise/Airtel Ug <rita.tamale@ug.airtel.com>';
	...
	if($_POST[payment_type] == 'Cash'){
		...
		$to = 'CREDITCOLLECTION@waridtel.co.ug,Leonard Kibuuka/Finance/Kampala <leonard.kibuuka@ug.airtel.com>, Rita Tamale/Credit Control/Uganda <Rita.Tamale@ug.Airtel.com>';
...
function build_invoices($billrun_date, $account_id=''){
	...
	sendHTMLemail($to='Steven Ntambi/Customer Service/Uganda <steven.ntambi@ug.airtel.com>, Emmanuel Agwa/IBM/Uganda <emmlagwa@ug.ibm.com>, Jamil Kireri/IT/Uganda <jamil.kireri@ug.airtel.com>, Vincent Lukyamuzi/CC/Kampala <vincent.lukyamuzi@ug.airtel.com>',$bcc='',$message=$mail_log,$subject='Data Services Invoice build on '.$billrun_date,$from='Data Billrun <ccnotify@waridtel.co.ug>');
